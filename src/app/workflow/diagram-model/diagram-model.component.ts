...
@Component({
  selector: 'app-diagram-model',
  templateUrl: './diagram-model.component.html',
  styleUrls: ['./diagram-model.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class DiagramModelComponent implements OnInit {
  constructor() {}
  ...
  @ViewChild('diagram')
  //Diagram Properties
  public diagram: any = DiagramComponent;
